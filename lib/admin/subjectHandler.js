        ...
        function(err, subs) {
          ...
          console.log(subs);
            res.render("admin/faculty/subject/subjecthome.hbs", {
                ...
                getacid: function(){return req.query.acid;}
...
router.get('/delsub',isLoggedIn,function(req,res){
    ...
    res.redirect('/admin/subjects/showsubject?acid='+req.body.acid);
});
...
router.get('/editsubject',isLoggedIn,function(req,res){
    ...
    return Subject.findById(req.query.id, function( err, subject ) {
      if( !err ) {
      console.log(subject);
            ...
            return console.log( err+"cant find subject" );
          }
      }); 
});
...
router.post('/editsubject',isLoggedIn,function(req,res){
    ...
    //console.log(req.query.id);
    //user : req.user   
    Subject.findById(req.body.subid,
      function(err, sub) {
        if (err){ 
