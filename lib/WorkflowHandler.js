...
WorkflowHandler.prototype.parseProcess = function( pro ){
	...
	console.log( pro['bpmn2:userTask'] );
	console.log( pro['bpmn2:intermediateThrowEvent'] );
	console.log( pro['bpmn2:intermediateCatchEvent'] );
	console.log( pro['bpmn2:sequenceFlow'] );*/
}

WorkflowHandler.prototype.parseCollaboration = function( col ){
	/*console.log( Object.keys(col) );
	console.log( col['bpmn2:participant'] );
	console.log( col['bpmn2:messageFlow'] );*/
}
...
WorkflowHandler.prototype.setMessageFlow = function( messageFlows ){
	...
	for( var i = 0; i < messageFlows.length; i++ ){
		...
		for( var j = 0; j < parameterList.length; j++ ){
			dummy[parameterList[j]] = messageFlows[i]['$'][parameterList[j]];
		}
