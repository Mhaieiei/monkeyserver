...
router.get('/editaun2-1',isLoggedIn,function(req,res){
    console.log('Edit aun 2-1');
...
router.post('/editaun2-1',isLoggedIn,function(req,res){
    console.log(']Post]Edit aun 2-1');
    console.log(req.query.id);
    ReferenceCurriculum.findById(req.query.id,function(err,ref){
...
router.get('/delaun2-1',isLoggedIn,function(req,res){
    console.log("[Post]Admin Delete aun2-1");
    ...
    Program.findOneAndUpdate({ 'programname' : req.query.program },
      ...
      res.redirect('/aun/aun2-1?program='+req.query.program+'&year='+req.query.year+'&acid='+req.query.acid);
});
