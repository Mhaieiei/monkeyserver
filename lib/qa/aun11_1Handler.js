...
//-------------------------------------------------add ELOs-------------------------------------------------------
 ...
 router.get('/', isLoggedIn, function (req, res) {
      ...
      console.log("req.query.academicYear: "+req.query.academicYear);
      ...
      Role.roleOfProgram.find({
        ...
        .exec(function (err, docs) {
            ...
            res.render('qa/qa-aun11.1.hbs', {
              ...
              Acyear.findOne({ '_id': req.query.academicYear }, function (err, programs) {
         ...
         User.update(
          ...
          , function(err, delete_elo_program) { 
            ...
            if (err){console.log('cant edit new program Management'+err);}  
              ...
              res.redirect('/aun/aun11-1?program='+req.query.program+"&year="+req.query.year+"&academicYear="+req.query.academicYear);
